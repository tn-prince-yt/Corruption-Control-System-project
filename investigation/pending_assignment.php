...
/**
 * Pending Assignment
 * List of approved complaints pending assignment to investigator
 */
...
<head>
    ...
    <title>Pending Cases - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <main>
        <div class="container">
            <h1 style="color: var(--primary-color); margin-bottom: 2rem;">Cases Available for Assignment</h1>
            ...
            <div style="background-color: white; padding: 2rem; border-radius: var(--border-radius); box-shadow: var(--box-shadow);">
                ...
                <?php else: ?>
                    <p style="color: #999; text-align: center; padding: 2rem;">No pending cases available.</p>
                <?php endif; ?>
            </div>
        </div>
    </main>
