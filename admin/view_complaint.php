...
<body>
    ...
    <main>
        <div class="container">
            <a href="manage_complaints.php" style="color: var(--secondary-color); margin-bottom: 1rem; display: inline-block;">← Back to Complaints</a>
            ...
            <div class="complaint-card" style="border-left: 4px solid var(--primary-color);">
                ...
                <?php if ($complaint['assigned_investigator_id']): ?>
                    <div style="margin-top: 1rem; padding: 1rem; background-color: #f0f4f8; border-radius: var(--border-radius);">
                        <strong>Assigned Investigator:</strong> <?php echo escapeHtml($complaint['investigator_name']); ?>
                    </div>
                <?php endif; ?>
            </div>
